...
--
-- Dumping data for table `ps_htl_order_refund_rules`
--

LOCK TABLES `ps_htl_order_refund_rules` WRITE;
/*!40000 ALTER TABLE `ps_htl_order_refund_rules` DISABLE KEYS */;
/*!40000 ALTER TABLE `ps_htl_order_refund_rules` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-12-18 16:43:42
