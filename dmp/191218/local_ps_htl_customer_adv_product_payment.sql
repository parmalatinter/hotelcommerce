...
--
-- Dumping data for table `ps_htl_customer_adv_product_payment`
--

LOCK TABLES `ps_htl_customer_adv_product_payment` WRITE;
/*!40000 ALTER TABLE `ps_htl_customer_adv_product_payment` DISABLE KEYS */;
/*!40000 ALTER TABLE `ps_htl_customer_adv_product_payment` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-12-18 16:42:57
