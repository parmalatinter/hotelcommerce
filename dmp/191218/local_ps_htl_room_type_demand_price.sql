...
--
-- Dumping data for table `ps_htl_room_type_demand_price`
--

LOCK TABLES `ps_htl_room_type_demand_price` WRITE;
/*!40000 ALTER TABLE `ps_htl_room_type_demand_price` DISABLE KEYS */;
/*!40000 ALTER TABLE `ps_htl_room_type_demand_price` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-12-18 16:43:15
