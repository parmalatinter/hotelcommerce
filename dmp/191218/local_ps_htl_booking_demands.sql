...
--
-- Dumping data for table `ps_htl_booking_demands`
--

LOCK TABLES `ps_htl_booking_demands` WRITE;
/*!40000 ALTER TABLE `ps_htl_booking_demands` DISABLE KEYS */;
/*!40000 ALTER TABLE `ps_htl_booking_demands` ENABLE KEYS */;
UNLOCK TABLES;
