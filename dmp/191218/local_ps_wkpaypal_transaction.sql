...
--
-- Dumping data for table `ps_wkpaypal_transaction`
--

LOCK TABLES `ps_wkpaypal_transaction` WRITE;
/*!40000 ALTER TABLE `ps_wkpaypal_transaction` DISABLE KEYS */;
/*!40000 ALTER TABLE `ps_wkpaypal_transaction` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-12-18 16:43:45
