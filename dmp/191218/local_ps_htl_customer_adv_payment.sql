...
--
-- Dumping data for table `ps_htl_customer_adv_payment`
--

LOCK TABLES `ps_htl_customer_adv_payment` WRITE;
/*!40000 ALTER TABLE `ps_htl_customer_adv_payment` DISABLE KEYS */;
/*!40000 ALTER TABLE `ps_htl_customer_adv_payment` ENABLE KEYS */;
UNLOCK TABLES;
