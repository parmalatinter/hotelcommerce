...
--
-- Dumping data for table `ps_htl_order_refund_info`
--

LOCK TABLES `ps_htl_order_refund_info` WRITE;
/*!40000 ALTER TABLE `ps_htl_order_refund_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `ps_htl_order_refund_info` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-12-18 16:42:54
