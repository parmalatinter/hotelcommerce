...
--
-- Dumping data for table `ps_htl_room_type_global_demand_advance_option_lang`
--

LOCK TABLES `ps_htl_room_type_global_demand_advance_option_lang` WRITE;
/*!40000 ALTER TABLE `ps_htl_room_type_global_demand_advance_option_lang` DISABLE KEYS */;
/*!40000 ALTER TABLE `ps_htl_room_type_global_demand_advance_option_lang` ENABLE KEYS */;
UNLOCK TABLES;
