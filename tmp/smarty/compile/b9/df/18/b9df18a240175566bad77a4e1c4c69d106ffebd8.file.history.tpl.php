<?php /* Smarty version Smarty-3.1.19, created on 2019-12-18 15:25:12
         compiled from "C:\Users\NCN\Documents\git\hotelcommerce2\themes\hotel-reservation-theme\history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:314165df9c648268db7-61829291%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b9df18a240175566bad77a4e1c4c69d106ffebd8' => 
    array (
      0 => 'C:\\Users\\NCN\\Documents\\git\\hotelcommerce2\\themes\\hotel-reservation-theme\\history.tpl',
      1 => 1576647666,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '314165df9c648268db7-61829291',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5df9c6485026a6_66618627',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5df9c6485026a6_66618627')) {function content_5df9c6485026a6_66618627($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include 'C:\\Users\\NCN\\Documents\\git\\hotelcommerce2\\tools\\smarty\\plugins\\modifier.regex_replace.php';
?>
...
<?php $_tmp6=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['order_refund_info']->value[$_tmp6]['waitting'];?>
 ...
 : <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['order']->value['id_order'];?>
<?php $_tmp7=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['order_refund_info']->value[$_tmp7]['accepted'];?>
 ...
 : <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['order']->value['id_order'];?>
<?php $_tmp8=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['order_refund_info']->value[$_tmp8]['rejected'];?>
 ...
 : <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['order']->value['id_order'];?>
<?php $_tmp9=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['order_refund_info']->value[$_tmp9]['refunded'];?>
...
<?php $_tmp10=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc',true,null,"submitReorder&id_order=".$_tmp10), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php } else { ?>
								<a class="link-button" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
<?php $_tmp11=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"submitReorder&id_order=".$_tmp11), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php }?>
