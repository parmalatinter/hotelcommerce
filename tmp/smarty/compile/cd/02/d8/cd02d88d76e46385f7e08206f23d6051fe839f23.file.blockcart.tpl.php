<?php /* Smarty version Smarty-3.1.19, created on 2019-12-18 15:25:13
         compiled from "C:\Users\NCN\Documents\git\hotelcommerce2\themes\hotel-reservation-theme\modules\blockcart\blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:42295df9c6499705a6-36004194%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cd02d88d76e46385f7e08206f23d6051fe839f23' => 
    array (
      0 => 'C:\\Users\\NCN\\Documents\\git\\hotelcommerce2\\themes\\hotel-reservation-theme\\modules\\blockcart\\blockcart.tpl',
      1 => 1576647670,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '42295df9c6499705a6-36004194',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5df9c64a08c3a3_84340056',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5df9c64a08c3a3_84340056')) {function content_5df9c64a08c3a3_84340056($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\Users\\NCN\\Documents\\git\\hotelcommerce2\\tools\\smarty\\plugins\\modifier.date_format.php';
if (!is_callable('smarty_modifier_replace')) include 'C:\\Users\\NCN\\Documents\\git\\hotelcommerce2\\tools\\smarty\\plugins\\modifier.replace.php';
if (!is_callable('smarty_function_counter')) include 'C:\\Users\\NCN\\Documents\\git\\hotelcommerce2\\tools\\smarty\\plugins\\function.counter.php';
?>
<!-- MODULE Block cart -->
...
<?php $_tmp14=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&id_product=".$_tmp12."&ipa=".$_tmp13."&id_address_delivery=".$_tmp14."&token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp16=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['id_customization']->value);?>
<?php $_tmp17=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&id_product=".$_tmp15."&ipa=".$_tmp16."&id_customization=".$_tmp17."&token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)), ENT_QUOTES, 'UTF-8', true);?>
" rel="nofollow">&nbsp;</a>
													</div>
